            ...
            {brands.map((brand, index) => (
              <SwiperSlide key={index}>
                <div className="w-[20vw]  max-md:w-[30vw] flex flex-col items-center justify-center ">
                  <div
                    className="h-[20vh] w-[20vh] max-md:h-[10vh] max-md:w-[10vh] rounded-full border-2 overflow-hidden
          ...
          >
            {d.map((category, index) => (
              ...
              >
                <div className="w-[20vw]  max-md:w-[30vw] flex flex-col items-center justify-center ">
                  <div
                    className="h-[20vh] w-[20vh] max-md:h-[10vh] max-md:w-[10vh] rounded border-2 overflow-hidden
        flex  flex-col items-center justify-center  "
                  >
                    <img
                      src={`/${category.img}`}
