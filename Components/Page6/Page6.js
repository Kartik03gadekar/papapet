  ...
  return (
    <section className="px-6 py-12 max-md:bg-[#F4EEE1] max-md:py-14">
      ...
      <div className="hidden md:block">
        ...
        <h3 className='text-end cursor-pointer text-[#0d9899] font-medium mt-4 mb-2'>View all</h3>
        ...
        <div className="grid grid-cols-2 gap-4 w-full pt-5">
          {mobileBlogs.map((blog) => (
            ...
            >
              ...
              />
              <h3 className="font-semibold text-sm sm:text-lg text-left">{blog.title}</h3>
            </div>
          ))}
        </div>
      </div>
