...
const ProductCard = ({ i, imgLink }) => {
  return (
    <Link href={`/papapet/product/${i._id}`}>
      <div className="w-full h-[40vh] flex flex-col bg-white overflow-hidden items-start justify-center p-2 border-2 rounded-xl border-gray-300 gap-2 max-md:h-fit max-md:overflow-hidden">
        <div className="w-full h-[7q0%] relative">
          <img
        ...
        <h3 className="text-xs opacity-80">{i?.brand}</h3>
