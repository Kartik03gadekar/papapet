  ...
  return (
    ...
    <div className="bg-gradient-to-t from-[#FFDEBA] to-white max-md:w-full max-md:py-5 max-md:px-5 flex flex-col items-center justify-center">
      ...
      <div className=" max-md:flex max-md:w-screen   max-md:gap-2 max-md:bg-teal-100 py-4  px-2  max-md:items-center  justify-center  max-md:mt-[4vw]  ">
        <div className="max-md:justify-center tween  max-md:flex max-md:items-center max-md:gap-1 max-md:w-[40vw] max-md:h-[15vw]
         max-md:bg-white  max-md:rounded-lg">
          <img src="/Page41.png" alt="Products" className="w-[7vw] h-[10vw] mx-2 "  />
          <p className="font-semibold">100+ <br/>  <span className="font-[400]  ">Products</span></p>
        </div>
        <div className="max-md:justify-center max-md:flex max-md:items-center max-md:gap-1 max-md:w-[40vw] max-md:h-[15vw]
         max-md:bg-white max-md:rounded-lg">
          <img src="/Page42.png" alt="Service" className="w-[7vw] h-[10vw] mx-2" />
          <p className="font-semibold">7+ <br/>  <span className="font-[400]  "> Service</span> </p>
        </div>
        <div className="max-md:justify-center  max-md:flex max-md:items-center max-md:gap-1 max-md:w-[40vw] max-md:h-[15vw]
         max-md:bg-white max-md:rounded-lg">
          <img src="/Page43.png" alt="Fast Delivery" className="w-[7vw] h-[10vw] mx-2"  />
          <p className="font-semibold">Fast <br/>  <span className="font-[400]  ">Delivery</span></p>
        </div>
      </div>
    </section>
        </div>
